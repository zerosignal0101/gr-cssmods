...
#include "css_demodulate_symbols_impl.h"
...
css_demodulate_symbols::sptr
css_demodulate_symbols::make(int sf, double bw, int zero_padding_ratio)
{
    return gnuradio::make_block_sptr<css_demodulate_symbols_impl>(
        sf, bw, zero_padding_ratio);
}
 ...
 */
css_demodulate_symbols_impl::css_demodulate_symbols_impl(int sf,
                                                         double bw,
                                                         int zero_padding_ratio)
    : gr::block("css_demodulate_symbols",
 ...
 */
css_demodulate_symbols_impl::~css_demodulate_symbols_impl() {}
...
void css_demodulate_symbols_impl::forecast(int noutput_items,
                                           gr_vector_int& ninput_items_required)
{
    // No stream output
}

int css_demodulate_symbols_impl::general_work(int noutput_items,
